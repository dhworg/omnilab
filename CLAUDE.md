...
full architecture and scope (**architecture rev 5.2 as of 2026-08-18 —
container-first delivery; Gazebo primary + MuJoCo supported, including
bridge-served visual verification**; see the amendment blocks at the top
of the spec).
...
| Simulator | Gazebo Harmonic (primary); MuJoCo (supported incl. visual verification — rev 5.2) |
